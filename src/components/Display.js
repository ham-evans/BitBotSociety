        ...
        <div className="display" id="roadmap">
            ...
            <div className='display__container'>
                <div className='display__text'>
                    ...
                    <div className='display__list'><h3 className='percentage'>25%&nbsp;</h3>	    <li>Community Activity & Leader Award (ETH Giveaway for Both) announced in Discord; Launch weekly podcast; Begin launch of Mixtape Vol. 1.</li></div>
